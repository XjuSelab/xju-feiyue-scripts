...
| 脚本 | 技术 ID | 用途 | 安装 / 更新 |
| :-- | :-- | :-- | :--: |
| **飞跃·解题 Solver** | `feiyue-solver` | 希冀（Java/OJ）AI 自动解题、一键开刷、章习题题库 | [![安装](https://img.shields.io/badge/安装-v2.7.0-00485B?style=flat-square)](https://feiyue.selab.top/feiyue-solver.user.js) |
